...
<?php $component->withAttributes(['submit' => 'apply']); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__("Auto Updates")); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__("You can apply lastest updates automatically from here if available.")); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('form', null, []); ?> 
        <div class="col-span-6">
            <div class="w-full py-3 px-4 overflow-hidden rounded-xl flex items-center border <?php echo e($status["available"] ? "bg-blue-50 dark:bg-blue-900" : "bg-gray-50 dark:bg-gray-900"); ?> <?php echo e($status["available"] ? "border-blue-500" : "border-gray-500"); ?>">
                ...
                <div class="ml-4 flex-1">
                    <div class="text-lg font-semibold"><?php echo e(__($status["available"] ? "Update Available" : 'You\'re on Latest Version')); ?></div>
     ...
     <?php $__env->slot('actions', null, []); ?> 
        <!--[if BLOCK]><![endif]--><?php if($status["available"] && ! $status["disabled"]): ?>
...
<?php endif; ?>
<?php /**PATH /home/tmail/public_html/resources/views/backend/updates/auto.blade.php ENDPATH**/ ?>