...
<?php $component->withAttributes([]); ?>
        <div class="flex justify-between items-center border-b px-6 py-4 text-sm dark:border-gray-700">
            <?php echo e(__("Messages Received")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.charts.area','data' => ['chartId' => $chartId,'chartData' => $chartData,'function' => 'updateChartData','color' => '#00C950']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['chartId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($chartId),'chartData' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($chartData),'function' => 'updateChartData','color' => '#00C950']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/tmail/public_html/resources/views/backend/dashboard/messages-received.blade.php ENDPATH**/ ?>