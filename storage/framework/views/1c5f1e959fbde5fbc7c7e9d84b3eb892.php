...
[$__name, $__params] = $__split("backend.menu.manage", ["location" => "primary"]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2590660471-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split("backend.menu.manage", ["location" => "secondary"]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2590660471-1', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /home/tmail/public_html/resources/views/backend/menu.blade.php ENDPATH**/ ?>