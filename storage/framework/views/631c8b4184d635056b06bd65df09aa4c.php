...
<div <?php echo e($attributes->merge(["class" => "$baseClasses $viewClasses"])); ?>>
    <!--[if BLOCK]><![endif]--><?php if(isset($title) && isset($description)): ?>
...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
        <form wire:submit="<?php echo e($submit); ?>">
            <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6 shadow <?php echo e(isset($actions) ? "sm:rounded-tl-2xl sm:rounded-tr-2xl" : "sm:rounded-2xl"); ?>">
...
<?php /**PATH /home/tmail/public_html/resources/views/components/form-section.blade.php ENDPATH**/ ?>