...
<?php $component->withAttributes(['submit' => 'save']); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__("Engine")); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__("You can select which engine to use with TMail. You can either use self-managed IMAP or use our dedicated product TMail Delivery.")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'engine','value' => ''.e(__('Engine')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'engine','value' => ''.e(__('Engine')).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['id' => 'engine','class' => 'mt-1 block w-full','wire:model.live' => 'state.engine']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'engine','class' => 'mt-1 block w-full','wire:model.live' => 'state.engine']); ?>
                    <option value="delivery"><?php echo e(__("TMail Delivery")); ?></option>
                    <option value="imap"><?php echo e(__("IMAP")); ?></option>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['for' => 'state.engine','class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'state.engine','class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($state["engine"] == "delivery"): ?>
            <a class="col-span-6 sm:col-span-4 px-5 py-3 rounded-md flex items-center justify-between font-bold" href="https://delivery.tmail.thehp.in" target="_blank" rel="noopener noreferrer" style="background-color: #383c72; color: #ffc145">
                <div class="flex justify-center items-center gap-2">
                    ...
                    <?php echo e(__("Register for TMail Delivery")); ?>
            ...
            <div x-data="{ show: false }" class="col-span-6 sm:col-span-4">
                <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'delivery_key','value' => ''.e(__('Delivery Authentication Key')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'delivery_key','value' => ''.e(__('Delivery Authentication Key')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald8ba2b4c22a13c55321e34443c386276)): ?>
<?php $attributes = $__attributesOriginald8ba2b4c22a13c55321e34443c386276; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'delivery_key','xBind:type' => 'show ? \'text\' : \'password\'','class' => 'mt-1 block w-full bg-gray-200 pr-28','autocomplete' => 'off','wire:model' => 'state.delivery.key','disabled' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'delivery_key','x-bind:type' => 'show ? \'text\' : \'password\'','class' => 'mt-1 block w-full bg-gray-200 pr-28','autocomplete' => 'off','wire:model' => 'state.delivery.key','disabled' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <div class="flex items-center gap-2 absolute inset-y-0 right-0 uppercase text-xs mr-3">
                        <div id="delivery-copy-btn" data-copied="<?php echo e(__("Copied")); ?>" data-copy="<?php echo e(__("Copy")); ?>" data-key="<?php echo e($state["delivery"]["key"]); ?>" class="cursor-pointer"><?php echo e(__("Copy")); ?></div>
...
<?php endif; ?>
<?php /**PATH /home/tmail/public_html/resources/views/backend/settings/engine.blade.php ENDPATH**/ ?>