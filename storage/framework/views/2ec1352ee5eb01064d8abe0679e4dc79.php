...
<?php $component->withAttributes([]); ?>
        <div class="flex justify-between items-center border-b px-6 py-4 text-sm dark:border-gray-700">
            <?php echo e(__("Users Registered")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.charts.area','data' => ['chartId' => $chartId,'chartData' => $chartData,'function' => 'updateChartData','color' => '#4336C8','height' => '350']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['chartId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($chartId),'chartData' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($chartData),'function' => 'updateChartData','color' => '#4336C8','height' => '350']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/tmail/public_html/resources/views/backend/dashboard/users-registered.blade.php ENDPATH**/ ?>