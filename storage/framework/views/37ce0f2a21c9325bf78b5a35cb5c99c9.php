...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((["style" => "", "size" => "xs", "icon" => "hgi-arrow-right-01", "position" => "right"]));
...
foreach (array_filter((["style" => "", "size" => "xs", "icon" => "hgi-arrow-right-01", "position" => "right"]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php
    $baseClasses = "flex gap-1 items-center px-4 py-2 border rounded-md font-semibold uppercase tracking-widest shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150";
...
<button <?php echo e($attributes->merge(["type" => "submit", "class" => "$baseClasses $styleClasses $sizeClasses"])); ?>>
    <!--[if BLOCK]><![endif]--><?php if($position == "left"): ?>
        <i class="hgi hgi-stroke <?php echo e($icon); ?>"></i>
...
<?php /**PATH /home/tmail/public_html/resources/views/components/secondary-button-icon.blade.php ENDPATH**/ ?>